...
export default function Retentiaquiz() {
  ...
  return (
    <main
      className="min-h-screen flex flex-col justify-center bg-background py-10
      ...
      >
        ...
        >
          <p className="text-xl sm:text-2xl md:text-3xl font-bold leading-relaxed p-6 sm:p-10 md:p-15 text-center">
            Which of the following energy sources cannot be replenished
            naturally on a human timescale?
          </p>
        </Card>
